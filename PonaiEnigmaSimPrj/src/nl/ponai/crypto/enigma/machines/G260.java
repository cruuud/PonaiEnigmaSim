 ...
 *
 */
public class G260 extends EnigmaSimulator
{
	public G260(String description)
	{
		super(description);
	}
	...
	public void configureMachine()
	{
		...
		Rotor rI=new Rotor(true,alphabet,"RCSPBLKQAUMHWYTIFZVGOJNEXD");
		Rotor rII=new Rotor(true,alphabet,"WCMIBVPJXAROSGNDLZKEYHUFQT");
		Rotor rIII=new Rotor(true,alphabet,"FVDHZELSQMAXOKYIWPGCBUJTNR");
	...
	{
		super.handleDisplayConfiguration("Possibly the Sicherheidsdienst (SD), the German Security Service");		
	}
}
